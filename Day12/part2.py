...
def getMinDistance(input):
    ...
    # get the shortest distance from the lowest points
    min_dist = 9999999999
    for e in keyElements['lowest']:
        if minDistance[e] < min_dist:
            min_dist = minDistance[e]

    return min_dist


if __name__ == '__main__':
    print("Part 2 : ", getMinDistance(readInput()))
